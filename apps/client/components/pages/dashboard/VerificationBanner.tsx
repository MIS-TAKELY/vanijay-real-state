...
interface VerificationBannerProps {
  /** When false (default) the banner is shown; hide it once L2 is reached. */
  show?: boolean;
  href?: string;
}

/**
 * Verification banner (DESIGN.md §5.1): amber banner —
 * "Complete identity verification to list property" [Upload citizenship →]
 * linking the Document Vault.
 */

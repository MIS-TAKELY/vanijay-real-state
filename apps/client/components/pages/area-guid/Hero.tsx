        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-[1fr_360px]">
          ...
          <div className="animate-[fadeIn_0.6s_ease-out]">
            ...
            <div
              ...
              className="bg-surface border border-outline-variant shadow-lg rounded-2xl overflow-hidden max-w-[560px] focus-within:ring-2 focus-within:ring-primary/30 focus-within:border-primary/40 transition-[box-shadow,border-color] duration-200"
            >
          ...
          <div className="animate-[fadeIn_0.8s_ease-out]">
            <div className="grid grid-cols-2 border border-outline-variant bg-surface shadow-md hover:shadow-lg transition-shadow rounded-2xl overflow-hidden">
              {STATS.map((stat, i) => (
                <div
                  key={stat.label}
                  className={`p-5 ${
            ...
            <p className="mt-3 text-[11px] text-on-surface-variant uppercase tracking-[0.6px] text-center font-semibold">

...
async function main() {
    ...
    const metals = [
        {
            ...
            seoDescription: "Live gold price in Nepali Rupees with historical charts, converter and FAQs.",
        },
        {
            slug: "silver",
            name: "Silver",
            ...
            seoDescription: "Live silver price in Nepal with historical charts and price converter.",
        },
        {
            slug: "copper",
            name: "Copper",
            ...
            seoDescription: "Live copper price in Nepal with historical charts and price converter.",
        },
        {
            slug: "diamond",
            name: "Diamond",
            ...
            seoDescription: "Diamond prices in Nepal with buying guide and price converter.",
        },
        {
            slug: "steel",
            name: "Steel",
            ...
            seoDescription: "Live steel price in Nepal with historical charts and price converter.",
        },
    ];
    ...
    const cats = [
        {
            ...
            nepali: "कागज र गत्ता",
            icon: "newspaper",
            blurb: "Newspapers, office paper, books and gatta (cardboard). Keep it dry for top rates.",
            seoTitle: "Paper & Cardboard Kabadi Rates in Kathmandu | Sell Scrap Paper",
            seoDescription: "Sell newspaper, office paper, books, notebooks and cardboard for the best rates in Kathmandu Valley. Newspaper at Rs 35/kg, cardboard at Rs 12/kg. Clean & dry for top prices.",
            seoKeywords: "sell newspaper Nepal, paper kabadi rate, cardboard price Kathmandu, newspaper rate per kg Nepal, gatta price, office paper scrap",
        },
        {
            slug: "plastic",
            name: "Plastic",
            nepali: "प्लास्टिक",
            icon: "recycling",
            blurb: "PET bottles, milk packets, buckets and hard plastic. Sorted plastic pays more.",
            seoTitle: "Plastic Kabadi Rates in Kathmandu | Sell PET Bottles & Hard Plastic",
            seoDescription: "Sell PET bottles, milk packets, hard plastic and drums in Kathmandu. PET bottles at Rs 20/kg, hard plastic at Rs 15/kg. Sorted plastic pays more.",
            seoKeywords: "sell plastic Nepal, PET bottle rate, hard plastic price, plastic kabadi Kathmandu, milk packet scrap rate, plastic drum price",
        },
        {
            slug: "metal",
            name: "Metals",
            nepali: "धातु",
            icon: "hammer",
            blurb: "Copper, brass, aluminum, iron and steel. The heavy hitters of the kabadi world.",
            seoTitle: "Metal Kabadi Rates in Kathmandu | Sell Copper, Brass, Iron & Aluminum",
            seoDescription: "Sell copper, brass, aluminum, iron, steel and tin for the best rates in Kathmandu. Copper at Rs 1,400/kg, brass at Rs 900/kg. Best prices in the valley.",
            seoKeywords: "copper price Nepal, sell brass, aluminum rate, iron scrap price, metal kabadi rate Kathmandu, tamasariya, taama rate Nepal",
        },
        {
            slug: "ewaste",
            name: "E-Waste",
            nepali: "इ-फोहोर",
            icon: "cpu",
            blurb: "Old phones, laptops, CPUs, monitors and printers. Value is per piece.",
            seoTitle: "E-Waste Kabadi Rates in Kathmandu | Sell Old Phones, Laptops & CPUs",
            seoDescription: "Sell old smartphones, laptops, desktop CPUs, monitors and printers in Kathmandu. Old smartphone at Rs 150/piece, laptop at Rs 350/piece. Responsible e-waste recycling.",
            seoKeywords: "sell old mobile Nepal, e-waste rate Kathmandu, old laptop price, CPU scrap value, monitor recycling Nepal, smartphone kabadi rate",
        },
        {
            slug: "appliance",
            name: "Appliances",
            ...
            icon: "refrigerator",
            blurb: "Fridges, washing machines, ACs, geysers and microwaves — priced per unit.",
            seoTitle: "Appliance Kabadi Rates in Kathmandu | Sell Fridges, ACs & Washing Machines",
            seoDescription: "Sell old refrigerators, washing machines, ACs, geysers and microwaves in Kathmandu. Fridge at Rs 1,800/piece, AC at Rs 2,500/piece. Free doorstep pickup.",
            seoKeywords: "sell old fridge Nepal, washing machine scrap price, AC kabadi rate, geyser price, microwave scrap value Kathmandu, appliance recycling",
        },
        {
            slug: "other",
            name: "Glass & Other",
            ...
            seoTitle: "Glass, Tires & Other Kabadi Rates in Kathmandu",
            seoDescription: "Sell glass bottles, old clothes, vehicle tires, batteries and scrap vehicles in Kathmandu. Glass at Rs 6/kg, scrap car at Rs 18,000/piece.",
            seoKeywords: "glass bottle rate Nepal, sell old clothes, tire scrap price, battery kabadi rate, car scrap Nepal, motorcycle scrap value",
        },
    ];
    const catIds = {};
    ...
    const heroSlides = [
        {
            ...
            subtitle: "Explore thousands of verified listings across the country. From luxury villas to cozy apartments, your perfect home awaits.",
        ...
        },
        {
            ...
            subtitle: "Discover premium properties in the most sought-after neighborhoods. Verified listings, transparent pricing, seamless experience.",
        ...
        },
        {
            ...
            subtitle: "Access detailed market insights, virtual tours, and direct owner contacts. Make informed decisions with confidence.",
    ...
    const categories = [
        ...
        },
        {
            key: "villas",
            title: "Villas",
            image: "https://images.unsplash.com/photo-1613977257363-707ba9348227?w=200&h=200&fit=crop",
        },
        {
            key: "land",
            title: "Land",
    ...
    const seos = [
        {
            ...
            description: "Browse field-verified land, residential, commercial & apartment listings across Nepal.",
        },
        {
            route: "/gold",
    ...
    await prisma.siteConfig.upsert({
        ...
        create: {
            key: "kabadi_footer",
            data: {
                description: "Nepal's transparent scrap price guide. Know what your kabadi is worth before you sell — then book a doorstep pickup and get cash on the spot, weighed on a transparent digital scale.",
    ...
    const adminPassword = process.env.ADMIN_SEED_PASSWORD || "MalpothAdmin@2026";
    const adminId = process.env.ADMIN_SEED_ID || "admin-" + (0, node_crypto_1.randomUUID)().slice(0, 8);
    ...
    await prisma.user.upsert({
        ...
        create: {
            ...
            accounts: {
                create: {
                    id: "acct-" + (0, node_crypto_1.randomUUID)().slice(0, 8),
                    accountId: adminId,
            ...
            sessions: {
                create: {
                    id: "sess-" + (0, node_crypto_1.randomUUID)().slice(0, 8),
    ...
    for (const o of demoOwners) {
        const owner = await prisma.user.upsert({
            where: { email: o.email },
            create: {
                id: "owner-" + (0, node_crypto_1.randomUUID)().slice(0, 8),
                name: o.name,
                email: o.email,
                emailVerified: true,
                role: ["SELLER"],
    ...
    const monthsAgo = (months, extraDays = 0) => new Date(Date.now() - months * 30 * 86400000 + extraDays * 86400000);
    const demoProperties = [
        {
            listingCode: "LOT-101-KTM",
            slug: "buddhanagar-101",
            title: "Residential plot, Buddhanagar",
            propertyType: client_1.PropertyType.RESIDENTIAL_LAND,
            province: "Bagmati",
            district: "Kathmandu",
            ...
            ownerIndex: 0,
            createdMonthsAgo: 11,
            status: client_1.PropertyStatus.LIVE,
        },
        {
        ...
        },
        {
            ...
            propertyType: client_1.PropertyType.RESIDENTIAL_HOUSE,
            province: "Bagmati",
            district: "Bhaktapur",
        ...
        },
        {
            ...
            propertyType: client_1.PropertyType.COMMERCIAL_LAND,
            province: "Bagmati",
            district: "Kathmandu",
            municipality: "Kathmandu MC",
            wardNumber: 11,
        ...
        },
        {
            ...
            propertyType: client_1.PropertyType.HERITAGE_HOME,
            province: "Bagmati",
            district: "Lalitpur",
            municipality: "Lalitpur MC",
            wardNumber: 4,
        ...
        },
        {
            ...
            propertyType: client_1.PropertyType.COMMERCIAL_SPACE,
            province: "Gandaki",
            district: "Kaski",
            municipality: "Pokhara MC",
            wardNumber: 8,
        ...
        },
        {
            ...
            propertyType: client_1.PropertyType.AGRICULTURAL_LAND,
            province: "Bagmati",
            district: "Kathmandu",
    ...
    for (let i = 0; i < demoProperties.length; i++) {
        ...
        await prisma.property.upsert({
            ...
            create: {
                ...
                status: p.status,
                verificationLevel: p.status === client_1.PropertyStatus.SOLD
                    ? client_1.VerificationStatus.LEVEL_3_FIELD_VERIFIED
                    : client_1.VerificationStatus.LEVEL_2_DOC_VERIFIED,
    ...
    for (const p of demoProperties.filter((x) => x.status === client_1.PropertyStatus.SOLD)) {
        ...
        await prisma.propertySaleRecord.upsert({
            ...
            create: {
                ...
                verificationLevel: client_1.VerificationStatus.LEVEL_3_FIELD_VERIFIED,

    ...
    <section className="bg-primary relative overflow-hidden border-y border-primary/20">
      ...
      <div className="relative z-10 mx-auto max-w-container-max px-gutter py-16 lg:py-20">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1fr_auto]">
          {/* Content */}
          <div>
            <span className="mb-4 inline-block rounded-full border border-on-primary/20 px-3 py-1 text-[10px] font-semibold uppercase tracking-[1px] text-on-primary/80">
              Specialized Service
            </span>
            <h2
              className="mb-4 text-[36px] font-semibold leading-tight text-on-primary"
              style={{
            ...
            <p className="mb-6 max-w-[440px] text-sm leading-6 text-on-primary/70">
            ...
            <ul className="mb-8 space-y-3">
              {FEATURES.map((f) => (
                <li
                  key={f.text}
                  className="flex items-center gap-3 text-sm text-on-primary/90"
                >
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-on-primary/10 text-on-primary/80">

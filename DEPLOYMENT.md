...
| `BETTER_AUTH_SECRET`   | _(run `openssl rand -base64 32`)_              | Secret for signing auth tokens                                      |
| `BETTER_AUTH_URL`      | `https://realstate-api.your-domain.com`        | Public API URL (cookie domain + redirects)                          |
| `GOOGLE_CLIENT_ID`     | _(from Google Cloud Console)_                  | OAuth                                                               |
| `GOOGLE_CLIENT_SECRET` | _(from Google Cloud Console)_                  | OAuth                                                               |

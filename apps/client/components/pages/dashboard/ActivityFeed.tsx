...
/**
 * Recent activity feed (DESIGN.md §5.1 left): mixed timeline (inquiry
 * received, document verified, price-drop on a favorite, appointment
 * scheduled), icon dots by type, mono timestamps, relative "2h ago".
 */
  ...
  return (
    <div className="rounded-2xl border border-outline-variant bg-surface p-md">
      ...
      <ol className="relative flex flex-col gap-md pl-sm">
        ...
        <span
          aria-hidden
          className="absolute left-[7px] top-1 bottom-1 w-px bg-outline-variant"
        />

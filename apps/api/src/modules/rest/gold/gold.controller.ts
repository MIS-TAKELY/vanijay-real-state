...
export class GoldController {
  ...
  listPublic() {
    return this.gold.listMetals(false);
  }

  @Get('api/v1/gold/metals/:slug')
  getMetal(@Param('slug') slug: string) {
    return this.gold.getMetal(slug);
  }

  @Get('api/v1/gold/overrides/:metalSlug')
  getOverride(@Param('metalSlug') metalSlug: string) {
    return this.gold.getActiveOverride(metalSlug);
  }
  ...
  @Roles('ADMIN')
  listAdmin() {
    return this.gold.listMetals(true);
  }
